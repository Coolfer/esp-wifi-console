...
- **OLED-экран** (128×32, SSD1306): крупно текущая скорость, IP, заряд и статус telnet-сессии. Гаснет через 60 с простоя. Поворот на 180° включается в `/settings`. Разметка под 128×64 сохранена и включается константой `SCREEN_HEIGHT`
