...
- **OLED-экран** (128×32, SSD1306): крупно текущая скорость, IP, заряд и статус telnet-сессии. Гаснет через 60 с простоя. Разметка под 128×64 сохранена и включается константой `SCREEN_HEIGHT`
