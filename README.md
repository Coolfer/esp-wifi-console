...
- Подсветка меток скруглена (`fillRoundRect`, радиус 2). Понадобились поля по 2 px по горизонтали: без них срезанные углы съедали верхние пиксели букв вроде `T` и `S`
